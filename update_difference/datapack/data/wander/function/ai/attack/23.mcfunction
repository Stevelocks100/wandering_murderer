...
execute unless block ~ ~ ~ #wander:air_ish run function wander:ai/destroy_nearby/init
execute unless block ~ ~1 ~ #wander:air_ish run function wander:ai/destroy_nearby/init
