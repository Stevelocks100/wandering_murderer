...
execute as @p[tag=wander.target] at @s unless entity @n[tag=wander.tower_player_distance,distance=0..1.5] run function wander:tower_collapse/get_tower_bottom
