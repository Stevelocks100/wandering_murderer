...
execute unless score attack_ai wander.data matches 1.. if score ai wander.data matches 22 unless score jump_tick wander.data matches -11.. run function wander:ai/attack/22
execute unless score attack_ai wander.data matches 1.. if score ai wander.data matches 23 unless score jump_tick wander.data matches -11.. run function wander:ai/attack/23
