...
execute if score break_out wander.data matches 1 if score jump_tick wander.data matches 21.. facing entity @p[tag=wander.target] feet positioned 0.0 0.0 0.0 rotated ~ -30 positioned ^ ^ ^2 summon area_effect_cloud run function wander:ai/jump/zzz/cloud4
