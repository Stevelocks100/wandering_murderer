...
item replace entity @s weapon.mainhand with beetroot_soup[item_model="wander:molotov_milktail",max_stack_size=16,food={saturation: 0.0f, nutrition: 0, can_always_eat: 1b},consumable={consume_seconds:999999999},custom_name={italic:false,text:"Molotov Milktail"},rarity="rare",custom_data={milk:1b}]
