...
$execute positioned $(x) $(y) $(z) run summon wandering_trader ~ ~ ~ {Tags:["wander.hitbox","wander"],attributes:[{id:"generic.scale",base:2},{id:"generic.max_health",base:1024}],NoGravity:1b,Health:1024,NoAI:1b,Silent:1b,Team:"wander.nocol",Invulnerable:1b}
