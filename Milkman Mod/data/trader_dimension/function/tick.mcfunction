...
execute in trader_dimension:pocket positioned 6 10 6 as @e[type=!player,distance=0..20,type=!item_display,type=!marker] at @s unless entity @p[distance=0..40] run tp @s ~ ~-1000 ~
execute in trader_dimension:pocket positioned 6 10 6 as @e[type=!player,distance=0..20,type=!item_display,type=!marker] at @s unless entity @p[distance=0..40] run kill @s
