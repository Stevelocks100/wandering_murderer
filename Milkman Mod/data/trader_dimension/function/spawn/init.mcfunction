...
execute if score hard_mode wander.data matches 1 run scoreboard players set random trader_dimension.temp 1
...
execute if score random trader_dimension.temp matches 2..4 in trader_dimension:pocket run function trader_dimension:spawn/summon_block with storage trader_dimension:temp
