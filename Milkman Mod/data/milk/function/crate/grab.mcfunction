...
item replace entity @s weapon.mainhand with beetroot_soup[custom_model_data=731,max_stack_size=3,food={saturation: 0.0f, nutrition: 0, can_always_eat: 1b, eat_seconds: 1000000.0f},custom_name='{"italic":false,"text":"Molotov Milktail"}',rarity="rare",custom_data={milk:1b},hide_additional_tooltip={}]
