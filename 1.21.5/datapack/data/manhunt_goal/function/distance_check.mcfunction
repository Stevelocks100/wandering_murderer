...
#execute facing 0 ~ 0 rotated ~180 0 positioned 0.0 ~ 0.0 positioned ^ ^ ^1000 summon AEC run function manhunt_goal:distance_check_aec
execute summon area_effect_cloud run function manhunt_goal:zzz/cloud1
