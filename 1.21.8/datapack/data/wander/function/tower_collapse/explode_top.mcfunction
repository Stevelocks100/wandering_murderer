...
execute store result score $z player_motion.api.launch run random value -200..200
execute as @a[distance=0..5] at @s run function player_motion:api/launch_xyz
