execute if score sword wander.attack_cooldown matches ..0 unless entity @s[tag=wander.threw_sword] run scoreboard players set attack_cd wander.data 30
...
execute store result score abduct_random wander.data run random value 1..18
