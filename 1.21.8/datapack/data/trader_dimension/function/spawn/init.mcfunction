...
execute if score random trader_dimension.temp matches 1..2 in trader_dimension:pocket run function trader_dimension:spawn/summon_entity with storage trader_dimension:temp
execute if score random trader_dimension.temp matches 3..6 in trader_dimension:pocket run function trader_dimension:spawn/summon_block with storage trader_dimension:temp
