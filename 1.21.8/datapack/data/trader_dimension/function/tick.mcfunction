...
execute in trader_dimension:pocket run forceload add -1 -1 1 1
...
execute in trader_dimension:pocket unless entity @n[tag=aj.trader_dimension.bone.line1] run function trader_dimension:summon
...
#execute in trader_dimension:pocket as @n[tag=!aj.trader_dimension.animation.trees.playing] run function animated_java:trader_dimension/animations/trees/play