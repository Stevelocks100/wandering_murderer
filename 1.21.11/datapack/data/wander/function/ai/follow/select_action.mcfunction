...
execute if score @p[tag=wander.target] wander.encounters matches 6..9 store result score random_action wander.temp run random value 2..3
execute if score @p[tag=wander.target] wander.encounters matches 10.. store result score random_action wander.temp run random value 2..3
