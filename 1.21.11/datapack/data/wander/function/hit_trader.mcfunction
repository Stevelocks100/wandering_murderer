...
tag @s add wander.keep_damage_dealt
...
execute unless score ai wander.data matches 20..28 if score ai wander.data matches 0..6 run function wander:ai/maybe_attack
