...
execute if score tower_amount tower.temp matches 5.. run scoreboard players set tick tower.temp 100
execute if score tower_amount tower.temp matches 5.. run tag @s add tower.success
execute if score tower_amount tower.temp matches 5.. run tag @s remove tower.player