...
item modify entity @s[predicate=milk:mainhand_milk,gamemode=!creative,gamemode=!spectator] weapon.mainhand milk:one_less
item modify entity @s[predicate=milk:offhand_milk,gamemode=!creative,gamemode=!spectator] weapon.mainhand milk:one_less
