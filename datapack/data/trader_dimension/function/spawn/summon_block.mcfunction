...
$execute if score random_block trader_dimension.temp matches 10 run summon falling_block 18 10 $(rand_z_pos) {Motion:[$(rand_x_motion)d,$(rand_y_motion)d,0.0d],Tags:["trader_dimension.chest_mob"],BlockState:{Name:"dried_kelp_block",Properties:{unstable:"true"}}}
