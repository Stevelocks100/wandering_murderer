...
execute at @s if entity @a[distance=0..2.5,tag=wander.potential_target] run scoreboard players add timer wander.data 600
execute at @s as @a[distance=0..2.5,tag=wander.potential_target] in trader_dimension:pocket run tp @s 5 0 5