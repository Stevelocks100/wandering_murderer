...
execute if score jump_tick wander.data matches -12..300 as @n[tag=aj.wander.root] run function animated_java:wander/variants/sword_none/apply
execute if score jump_tick wander.data matches -12 if entity @n[tag=wander.sword_proj_display_landed,distance=0..10] run scoreboard players set jump_tick wander.data 42

execute if score jump_tick wander.data matches 0 run function wander:ai/jump/get_distance
execute if score jump_tick wander.data matches -11..39 facing entity @n[tag=wander.sword_proj_display_landed] eyes run tp @n[tag=aj.wander.root] ~ ~ ~ ~ 0
