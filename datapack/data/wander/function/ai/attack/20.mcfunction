...
execute if entity @p[tag=wander.target,distance=0..2] run scoreboard players remove attack_cd wander.data 4

execute if entity @p[tag=wander.target,distance=0..2] if score attack_cd wander.data matches ..0 run function wander:ai/attack/attack
