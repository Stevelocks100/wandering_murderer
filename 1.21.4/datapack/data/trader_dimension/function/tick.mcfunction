...
execute in trader_dimension:pocket positioned 6 10 6 unless entity @p[distance=0..40] as @e[type=item,distance=0..50] at @s run function trader_dimension:throw_items
