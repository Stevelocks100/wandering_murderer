...
execute if score player_height wander.temp matches 6.. unless function wander:ai/underground/underground_check if score do_griefing milk.settings matches 1 run scoreboard players set ai wander.data 21
...
execute if function wander:ai/underground/underground_check if score player_height wander.temp matches -2..1 if score do_digging milk.settings matches 1 run scoreboard players set ai wander.data 23
